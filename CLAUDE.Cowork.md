...
- 対をなす薄い設定書: [CLAUDE.md](CLAUDE.md)（Claude Code 向け） ／ [.github/copilot-instructions.md](.github/copilot-instructions.md)（Copilot 向け）
- 作画支援スキル: `numbertales-imagegen`（ナンバーテールズの作画依頼時に使用）
