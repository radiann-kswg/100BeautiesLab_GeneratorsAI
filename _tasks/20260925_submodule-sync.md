...
|---|---|---|---|---|---|
| `_creations-ai` | origin/master | e2307fa | ca88db6 | UPDATED | FF 取り込み完了 |
| `_creations-ai/creations-db` | origin/addon-ai-tag | 08971a2 | 08971a2 | NO-CHANGE | 最新 |

## 取り込んだ更新の内容

### `_creations-ai` e2307fa..ca88db6

```
ca88db6 chore: sync ai-dataset (creations-db@08971a2e) 窶・ai_training allowed: 160 -> 161 [skip ci]
```
...
ai-dataset/build-info.json                        |  12 +-
 ai-dataset/image-index.json                       |  25 +++-
 ai-dataset/index.json                             |  12 +-
 ai-dataset/manifest-training.jsonl                |  14 +-
 ai-dataset/manifest.jsonl                         | 150 ++++++++++++++++++----
 ...
 ai-dataset/works/Works_UnauthedLogica.json        | 127 +++++++++++++++++-
