...
|---|---|---|---|---|---|
| `_creations-ai` | origin/master | eea3725 | 189ce38 | UPDATED | FF 取り込み完了 |
| `_creations-ai/creations-db` | origin/addon-ai-tag | e1248de | e1248de | NO-CHANGE | 最新 |

## 取り込んだ更新の内容

### `_creations-ai` eea3725..189ce38

```
189ce38 chore: sync ai-dataset (creations-db@e1248de) 窶・ai_training allowed: 155 -> 156 [skip ci]
```
...
ai-dataset/build-info.json                        | 10 +++++-----
 ai-dataset/image-index.json                       |  7 ++++---
 ai-dataset/index.json                             |  6 +++---
 ai-dataset/manifest-training.jsonl                |  7 ++++---
