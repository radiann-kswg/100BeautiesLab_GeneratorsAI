# AppearanceDetail 充足性レビュー（配色検知ツール向け） — 57(イズナ) / humanoid
...
自動生成: `python -m src.tools.verify_appearance_detail --num 57 --check coverage --form humanoid` (100BeautiesLab_GeneratorsAI)
